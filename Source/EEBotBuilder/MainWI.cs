...
{
    public partial class MainWI : Form
    {
        Socket s = null;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are you sure you want to convert your code into an executable file?\nYour code will get compiledinto a file in the same directory as this application, aswell as the .exe!", "You sure?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
            {
